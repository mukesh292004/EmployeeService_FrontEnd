...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, NgChartsModule, NgApexchartsModule], // Add FormsModule here
  templateUrl: './attendancemanagement.component.html',
  styleUrl: './attendancemanagement.component.css'
})
export class AttendancemanagementComponent implements OnInit {
  userId: number | null = null; // Employee ID entered by the manager
  enteredEmployeeId: number | null = null; // For manual input
  ...
  ngOnInit(): void {
    // Remove automatic fetching of user ID from session
  ...
  fetchRecordsForEmployee(): void {
    if (this.enteredEmployeeId) {
      this.userId = this.enteredEmployeeId;
      this.fetchAttendanceHistory();
      this.fetchMonthlyReport();
      this.calculateWeeklyHours();
      this.updateMonthlyView();
